...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=homescreen&box=11.782603,46.549017,11.678108,46.477152
...
-----------
  ...
  * homescreen Height Map (ASTER 30m).png
  ...
  * homescreen Height Map (Merged).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * homescreen Height Map (SRTM3 v4.1).png
  ...
  * homescreen Height Map (SRTM30 Plus).png
...
These heightmaps were adjusted such that 1412m (actual) is equal to 40m in
